...
/* package */ class Samples {
    ...
    public static final Sample[] SIMPLE = new Sample[]{
            ...
            new Sample("Dizzy sd kártyáról", "dizzysd",
                    "/storage/extSdCard/dizi.mp4", DemoUtil.TYPE_OTHER, false, true),

            new Sample("TMIT - 3GP", "01",
                    "/storage/extSdCard/tmit.3gp", DemoUtil.TYPE_OTHER, false, true),
            new Sample("demo.flv - nem megy!", "02",
                    "/storage/extSdCard/demo.flv", DemoUtil.TYPE_OTHER, false, true),
            new Sample("TMIT - MP3", "03",
                    "/storage/extSdCard/tmit.mp3", DemoUtil.TYPE_OTHER, false, true),
            new Sample("TMIT - WEBM", "04",
                    "/storage/extSdCard/tmit.webm", DemoUtil.TYPE_OTHER, false, true),
            new Sample("TMIT - MP4 480p", "05",
                    "/storage/extSdCard/tmit-480p.mp4", DemoUtil.TYPE_OTHER, false, true),
            new Sample("TMIT - MP4 720p", "06",
                    "/storage/extSdCard/tmit-720p.mp4", DemoUtil.TYPE_OTHER, false, true),
            new Sample("TMIT - 128kbps audio only - WEBM", "07",
                    "/storage/extSdCard/tmit-audio-only-128kbps.webm", DemoUtil.TYPE_OTHER, false, true),
            new Sample("DASH mp4 darab", "08",
                    "/storage/extSdCard/fragment", DemoUtil.TYPE_OTHER, false, true),
            new Sample("DASH multirate", "09",
                    "http://download.tsi.telecom-paristech.fr/gpac/DASH_CONFORMANCE/TelecomParisTech/mp4-onDemand/mp4-onDemand-mpd-V.mpd", DemoUtil.TYPE_DASH, false, true)
    };
